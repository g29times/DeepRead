...
// gemini-flash-latest   gemini-flash-lite-latest   gemini-flash-lite-latest
...
async function chatWithAI(userMessage, chatHistory = [], pageContent = '', images = []) {
    ...
    const systemPrompt = `
        ...
        用户信息：Neo，数学/计算机专业本科，美国IIT学院ECE专业研究生毕业，15年编程经验，现居深圳。
        荣格八维Ti-Ne，金牛座，喜欢科技、文化历史、视觉艺术（如电影、摄影、观展）音乐、天文、旅行、游泳、滑雪。
